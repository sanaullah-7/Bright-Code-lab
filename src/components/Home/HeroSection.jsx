...
export default function HeroSection() {
  return (
    <motion.main
      className="pt-28  overflow-x-hidden overflow-y-hidden"
      variants={container}
      initial="hidden"
      animate="visible"
    >
      ...
      <div className="flex flex-col items-center md:items-start md:flex-row justify-center lg:gap-12 mt-10 md:mt-32 w-full px-5 sm:px-8 md:px-10">
        ...
        >
          <h1 className="w-[70vw] md:w-80 text-darklab leading-7">
            ...
            skilled engineers, Poland-based. We know what it takes
            to ship the right way.
          </h1>
      ...
      <h1
        variants={item}
        className="text-gray text-center mt-28 sm:mt-10"
      >
