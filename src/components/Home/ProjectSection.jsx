  ...
  return (
    <section className="pb-20">
      <div className="max-w-7xl px-2 md:px-52 mx-auto space-y-6">
        ...
        {/* Content */}
        <div className="flex items-end justify-between gap-4 md:gap-8 space-y-8 mt-16 px-5 sm:px-14 md:px-24 lg:px-0">
          ...
          <div className=" space-y-6">
            ...
            <p className="text-sm sm:text-base text-gray-600 w-[38vw]">
            ...
            <button className="border border-black px-4 py-2 rounded-full tracking-wide cursor-pointer hover:bg-blue-300 hover:border-blue-300 transition-all duration-300">
