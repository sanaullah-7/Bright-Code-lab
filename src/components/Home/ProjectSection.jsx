...
export default function ProjectSection() {
  return (
    <section className="pb-20">
      <div className="  max-w-7xl px-2 mdd:px-52 mx-auto space-y-6">
        {/* Heading */}
        <h1 className="h-2 bg-darkblue  rounded-2xl w-32 hidden mdd:flex  "></h1>
        <h1 className=" text-4xl mdd:text-5xl tracking-wider text-center mdd:text-left">
          Our <span className="text-darkblue">Project Portfolio</span>
        </h1>
        

        {/* Buttons */}
        <div className="flex flex-wrap gap-3 justify-center mdd:justify-start">
        ...
        <div className="flex items-end justify-between sm:gap-1 lg:gap-52 xl:gap-80 mt-16 px-5 sm:px-14  lg:px-0">
          ...
          <div className="space-y-6">
            <h1 className="text-xl sm:text-2xl mdd:text-3xl max-w-xl">
